export function renderStep2Belongings(container) {
  container.innerHTML = `
    <div class="step1-page">
      ...
      <div class="step1-content">
        ...
        <div class="step2-card">
          <div class="step2-card__header">
            ...
            <p class="step2-card__desc">Ingrese el <strong>valor comercial del inmueble</strong>. Este será el valor por el que quedará asegurada.</p>
          </div>
          <div class="step2-card__form">
            <div class="step2-form-row"><div class="step1-form-group"><label class="step1-form-label">Valor comercial del inmueble</label><input type="text" class="step1-input" placeholder="Ej: $250.000.000"></div><div class="step1-form-group"><label class="step1-form-label">Material predominante en que está construida la vivienda</label><select class="step1-input step1-select"><option>Seleccione el material predominante</option></select></div></div>
            <div class="step2-form-row"><div class="step1-form-group"><label class="step1-form-label">Años de antigüedad de la vivienda</label><select class="step1-input step1-select"><option>Seleccione el rango de años.</option></select></div><div class="step1-form-group"></div></div>
          </div>
        </div>
      ...
      <div class="step1-bottom"><button class="step1-bottom__btn" id="btn-continue-step2">Continuar</button></div>
    </div>
  `;
