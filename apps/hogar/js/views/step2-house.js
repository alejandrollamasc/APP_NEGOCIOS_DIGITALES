  ...
  container.innerHTML = `
    <div class="step1-page">
      ...
      <div class="step1-content">
        ...
        <!-- Card 1: Ubicación de la vivienda -->
          ...
          <div class="step2-card__form">
            <div class="step2-form-row">
              ...
              <div class="step1-form-group">
                ...
                <input type="text" class="step1-input" placeholder="Ej: Calle 1 # 1-23">
              </div>
            </div>
            <div class="step2-form-row">
              <div class="step1-form-group">
              ...
              <div class="step1-form-group">
                <label class="step1-form-label">Información adicional</label>
                <input type="text" class="step1-input" placeholder="Ej: Torre / apto / piso / casa">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="step2-card__form">
            <div class="step2-form-row">
              <div class="step1-form-group">
                ...
                <input type="text" class="step1-input" placeholder="Ej: $250.000.000">
              </div>
              <div class="step1-form-group">
      ...
      <div class="step1-bottom">
        <button class="step1-bottom__btn" id="btn-continue-house">Continuar</button>
      </div>
    </div>
  `;
}
